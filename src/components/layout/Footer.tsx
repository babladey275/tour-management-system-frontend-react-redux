    ...
    <footer className="border-t">
      <div className="mx-auto container space-y-8 px-4 py-16 lg:space-y-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-muted-foreground">
              Discover unforgettable travel experiences with us. We plan,
              manage, and guide your tours with comfort, safety, and care.
            </p>
        ...
        <p className="text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()}. Tour Management. All rights
          reserved.
        </p>
      </div>
    </footer>
